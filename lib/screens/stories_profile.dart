...
class StoriesProfile extends StatefulWidget {
  const StoriesProfile({super.key});

  @override
  State<StoriesProfile> createState() => _ProfileState();
}

class _ProfileState extends State<StoriesProfile> {
  int _current = 0;
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 8), // Espaçamento entre a foto e o texto
                const Column(
